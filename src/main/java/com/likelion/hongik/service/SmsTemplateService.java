...
public class SmsTemplateService {
    ...
    public String buildMessage(SmsType type) {
        ...
        “서류 합격자”는 반드시 오늘 18시까지 010-2257-1815으로 확인 여부 회신 부탁드립니다.
        Ex) 김멋사, 3월 3일 17시 30분 면접 일정 확인했습니다.
        ...
        최종 합격자에 한해 면접 일정 및 장소가 함께 공지되었습니다. 
        “최종 합격자”는 반드시 오늘 18시까지 010-3120-2936으로 확인 여부 회신 부탁드립니다.
        Ex) 김멋사, 확인했습니다. 
